    ...
    public partial class LoginWindow : Window
    {
        ...
        private async void LoginButton_Click(object sender, RoutedEventArgs e)
        {
            ...
            try
            {
                ...
                if (session != null)
                {
                    // Используем минимальный DI: берем MainViewModel из App.Services и передаем в MainWindow
                    var provider = App.Services;
                    ViewModels.MainViewModel? mainVm = null;
                    if (provider != null)
                    {
                        mainVm = provider.GetService(typeof(ViewModels.MainViewModel)) as ViewModels.MainViewModel;
                    }

                    var mainWindow = mainVm != null ? new MainWindow(mainVm) : new MainWindow(new ViewModels.MainViewModel(SupabaseService.Instance));
